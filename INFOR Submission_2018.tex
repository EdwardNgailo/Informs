...
\author{
\name{C.J. Duan\textsuperscript{a}\thanks{CONTACT C.J. Duan. Email: research@dulun.com} and Anuj Gorav\textsuperscript{b}}
\affil{\textsuperscript{a}Dulun Consulting Group, Riverside, California, U.S.A.; \textsuperscript{b}Troy University, Alabama, U.S.A.}
}
...
%===============================================================================
\begin{table}
	\tbl{The Villagers’ Benefit and Cost Matrix.}
	{\begin{tabular}{lccc} \toprule
			...
			\bottomrule
	\end{tabular}}
	\tabnote{Adapted from \cite{doi:10.1175/1520-0434(2004)019<0391:TBWCWR>2.0.CO;2} }
	\label{tab1}
\end{table}
%===============================================================================
...
\begin{table}
	...
	{\begin{tabular}{lcc} \toprule
			...
			\bottomrule
	\end{tabular}}
	\tabnote{Adapted from \cite{7727750} }
	\label{tab2}
\end{table}
%=====================================================================================
...
\begin{table}
	...
	{\begin{tabular}{clcc} \toprule 
			...
			\bottomrule
	\end{tabular}}
	\tabnote{Models differ in features included }
	\label{tab3}
\end{table}
%================================
...
\begin{table}
	...
	{\begin{tabular}{cccccc} \toprule 
			...
			\bottomrule
	\end{tabular}}
	\tabnote{All models with the same set of features\\ 
