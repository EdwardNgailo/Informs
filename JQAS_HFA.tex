...
The current conceptualization and operationalization of HFA prompt us to take an alternative route in search of true latent HFA underlying numbers in record books. Specifically, we seek in this paper to achieve the following goals: 
