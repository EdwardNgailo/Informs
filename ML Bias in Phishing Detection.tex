...
\ARTICLEAUTHORS{%
\AUTHOR{C.J.Duan}
\AFF{DulunConsulting Group, \EMAIL{research@dulun.com}, \URL{}}
%\AUTHOR{Author2}
...
\KEYWORDS{machine learning, Type I and II errors, CHAID,  Litmus  ratio, decision bias, CRAN-R, phishing websites classification}
\HISTORY{}
...
\item To discuss how human model adopters can use our proposed Litmus ratio and tailor ML models to the circumstances 
