...
\item To demonstrate empirically model bias is unrelated to accuracy and requires human judgment to curb the implied downsides. 
\item To discuss how human model adopters can be 
